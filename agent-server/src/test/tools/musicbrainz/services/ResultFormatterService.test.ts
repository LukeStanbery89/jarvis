import { ResultFormatterService } from '../../../../tools/musicbrainz/services/ResultFormatterService';
...
describe('ResultFormatterService', () => {
    ...
    describe('formatResults', () => {
        ...
        it('should format multiple results', () => {
            ...
            expect(result.split('\n\n').length).toBeGreaterThan(2); // Header + 2 albums
        });
    });
    ...
    describe('formatSingleResult', () => {
        ...
        it('should format unknown entity types generically', () => {
            const item = {
                ...
                longField: 'a'.repeat(200) // This should be filtered out
            };
    ...
    describe('duration formatting', () => {
        it('should format durations correctly', () => {
            const recording1 = { title: 'Short Song', length: 65000 }; // 1:05
            const recording2 = { title: 'Long Song', length: 600000 }; // 10:00
        ...
        it('should pad seconds with leading zeros', () => {
            const recording = { title: 'Test Song', length: 125000 }; // 2:05
