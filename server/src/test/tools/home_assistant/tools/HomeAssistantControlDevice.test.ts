import { createHomeAssistantControlDevice } from '../../../../tools/home_assistant/HomeAssistantControlDevice';
import { IHomeAssistantService, ControlResult, HomeAssistantAction } from '../../../../tools/home_assistant/interfaces/IHomeAssistantServices';
...
describe('HomeAssistantControlDevice', () => {
    ...
    it('should handle malformed JSON with missing fields', async () => {
        ...
        const tool = createHomeAssistantControlDevice(mockService);
        const input = JSON.stringify({ entity_id: 'switch.lamp' }); // missing action
