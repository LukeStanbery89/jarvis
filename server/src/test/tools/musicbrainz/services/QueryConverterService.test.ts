import { OpenAIQueryConverter } from '../../../../tools/musicbrainz/services/QueryConverterService';
import { IChatLLM } from '../../../../tools/shared/types';
import { ILogger } from '../../../../tools/musicbrainz/interfaces/IMusicBrainzServices';
...
describe('OpenAIQueryConverter', () => {
    ...
    describe('convertToMusicBrainzFormat', () => {
        ...
        it('should convert natural language queries using LLM', async () => {
            ...
            mockLLMClient.invoke.mockResolvedValue({ content: llmResponse });
        ...
        it('should include the conversion prompt template correctly', async () => {
            ...
            mockLLMClient.invoke.mockResolvedValue({ content: 'artist:test' });
